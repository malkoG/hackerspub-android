...
How is the polling interval?

### Prompt 29

Can we parameterize? 
For example, not connected 15 minutes, but connected 1minutes
...
Can you reduce the notification complexity for graphql query?
...
No need to add notificationpoll query
...
15 MINUTE is the best? really?

### Prompt 38

How notification spawned? What criteria?

### Prompt 39

When get notified, do we have also indicator for unread? on bottom nav bar?

### Prompt 40

Version number from Settings doesn't follow actual apps version number. How can we share such value?>

### Prompt 41

Could you see Settings Page?
